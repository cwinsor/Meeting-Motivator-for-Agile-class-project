 ...
 */
public class A01aCreateStandupActivity extends SingleFragmentActivity {
    private String TAG = this.getClass().toString();

    // create an Intent that can be used to start this activity
    public static Intent newIntent(Context packageContext) {
        Intent intent = new Intent(packageContext, A01aCreateStandupActivity.class);
        return intent;
    }
    ...
    protected Fragment createFragment() {
        ...
        return new A01aCreateStandupFragment();
    }
