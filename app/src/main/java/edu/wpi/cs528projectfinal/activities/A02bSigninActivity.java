 ...
 */
public class A02bSigninActivity extends SingleFragmentActivity {
    private String TAG = this.getClass().toString();

    // create an Intent that can be used to start this activity
    public static Intent newIntent(Context packageContext) {
        Intent intent = new Intent(packageContext, A02bSigninActivity.class);
        return intent;
        // this is a comment !
    }
